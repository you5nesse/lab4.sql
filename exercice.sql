...
SELECT abonne.nom, ouvrage.titre
FROM emprunt
JOIN abonne ON emprunt.abonne_id = abonne.id
JOIN ouvrage ON emprunt.ouvrage_id = ouvrage.id;
SELECT 
  abonne.id,
  abonne.nom,
  COUNT(*) 
...
VALUES ('younesse', 'younesse@example.com');
   INSERT INTO emprunt (ouvrage_id, abonne_id)
    VALUES (1, @n_abonne_id),
           (2, @n_abonne_id);
